...
/// Maps an FFT magnitude spectrum to log-spaced frequency bands and to
...
struct BandMapper {
    ...
    /// Average magnitude per log-spaced band.
    ...
    /// Average magnitude in the bass, mid, and treble ranges.
    ...
    /// Spectral centroid (brightness), normalized 0...1 against the Nyquist.

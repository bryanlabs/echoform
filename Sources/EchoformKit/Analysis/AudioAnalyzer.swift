...
/// Turns mono audio buffers into `AnalysisFrame`s.
///
/// Computes loudness (RMS), peak, an FFT magnitude spectrum mapped to
/// log-spaced bands, bass / mid / treble, spectral centroid, zero-crossing
/// rate, and a waveform snapshot. Band levels are auto-gained so the visuals
/// stay well-scaled regardless of how loud the source is.
